...
export default function TermsError({
  ...
  useEffect(() => {
    console.error("[terms error boundary]", {
    ...
    <main className="mx-auto max-w-4xl px-6 py-12">
      <section className="rounded-2xl border p-6">
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-tight">
          The terms page could not be rendered
        </h1>

        <p className="mt-3 text-sm text-muted-foreground">
          The failure has been contained to the terms route so the rest of the
        ...
        <div className="mt-5 rounded-xl border bg-muted/40 p-4">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-muted-foreground">
            ...
            <li>Return to the home page and reopen Terms.</li>
            <li>Use Privacy or About while this route is unavailable.</li>
          </ul>
        </div>
