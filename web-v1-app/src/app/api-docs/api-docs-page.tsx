...
export default async function ApiDocsPage() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-10">
      ...
      <div className="mb-8 flex items-start gap-5 rounded-2xl border border-cyan-500/20 bg-cyan-500/5 p-5">
        <div className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-cyan-500/30 bg-cyan-500/15 text-lg">
          👋
        </div>
        <div className="min-w-0">
          <div className="text-sm font-bold text-white">New to JSON APIs?</div>
          <p className="mt-1 text-sm leading-6 text-slate-400">
            Before diving into the technical reference, read the beginner guide. It explains
            what you actually receive, how to make your first request, and how to automate
            daily fetching — no prior API experience required.
          </p>
          <Link
            href="/api-docs/getting-started"
            className="mt-3 inline-flex items-center rounded-full border border-cyan-500/30 bg-cyan-500/10 px-4 py-1.5 text-xs font-semibold text-cyan-200 hover:bg-cyan-500/20 transition-colors"
          >
