...
function CodeBlock({ children, label }: { children: string; label?: string }) {
  return (
    <div>
      {label ? (
        <div className="mb-1.5 text-[10px] font-black uppercase tracking-wider text-[#557099]">
          {label}
        </div>
      ) : null}
      <pre className="overflow-x-auto rounded-2xl border border-[#86a9cc] bg-[#031329] p-5 text-xs font-semibold leading-6 text-slate-100 shadow-inner">
        <code>{children}</code>
      </pre>
    </div>
  );
...
function Section({ eyebrow, title, subtitle, children, id }: {
  ...
  return (
    <UrdSection id={id} eyebrow={eyebrow} title={title}>
      {subtitle ? (
        <div className="mb-5 max-w-4xl text-sm font-semibold leading-7 text-[#27476f]">
          {subtitle}
        </div>
      ) : null}
      {children}
...
function QA({ question, children }: { question: string; children: ReactNode }) {
  return (
    <UrdCard className="rounded-2xl p-5">
      ...
      <div className="mt-3 pl-6 text-sm font-semibold leading-7 text-[#27476f]">{children}</div>
    </UrdCard>
  );
}
  ...
  return (
    <UrdCard className="rounded-2xl p-5">
      <div className="flex items-center gap-3">
        <span className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-[#86a9cc] bg-[#f4f9ff] text-xs font-black text-[#0d2447]">
          {number}
        </span>
        <h3 className="text-base font-black text-[#0d2447]">{title}</h3>
      </div>
      <div className="mt-4 text-sm font-semibold leading-7 text-[#27476f]">{children}</div>
    </UrdCard>
  );
}
...
function BulletList({ items }: { items: ReactNode[] }) {
  return (
    <ul className="list-disc space-y-2 pl-5 text-sm font-semibold leading-7 text-[#27476f]">
...
function Callout({ children, color = "cyan" }: { children: ReactNode; color?: "cyan" | "amber" | "emerald" }) {
  return (
    <UrdCallout tone={color === "amber" ? "warning" : "info"}>
      {children}
    </UrdCallout>
  );
}
...
export default function GettingStartedJsonApiPage() {
  return (
    <UrdPage>
      <PageHero
        eyebrow="API Docs"
        title="Getting started with the"
        highlight="Urd Atlas JSON API"
        summary={
          <>
      ...
      <UrdContainer>
        <UrdCard className="mb-8">
          <div className="text-xs font-black uppercase tracking-wider text-blue-700 mb-3">Contents</div>
          <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3 text-sm">
            {[
              ...
              <a key={href} href={href} className={cx(urd.navItem, "inline-flex justify-center")}>{label}</a>
            ))}
          </div>
        </UrdCard>
      <ShortFullContent
    ...
    { "metric": "median_tx_fee_native", "z_robust": -2.02 }
          ...
          <div className="mt-5 grid gap-4 lg:grid-cols-3">
            {[
              ...
              <div key={item.title} className="rounded-2xl border bg-[#f8fbff] p-4">
          ...
          <Callout color="cyan">
            <span className="font-black text-[#0d2447]">Key point:</span>{" "}
        ...
        <Section id="what-is-api" eyebrow="Chapter 2" title="What an API is">
          ...
          <div className="mt-5 rounded-2xl border border-[#a7c2dd] bg-[#eaf4ff] p-5">
            <h3 className="text-sm font-bold text-[#0d2447] mb-4">The difference — with and without an API</h3>
            <div className="grid gap-4 lg:grid-cols-2">
              <div className="rounded-xl border border-[#a7c2dd] p-4">
          ...
          <div className="mt-5">
            ...
            <Callout color="amber">
              <span className="font-black text-[#0d2447]">Important:</span>{" "}
          ...
          <div className="mt-5 overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody className="text-[#27476f]">
                ...
                <tr className="border-b border-[#c0d4e8]">
                  <td className="py-3 pr-6 font-bold text-violet-700">Meta</td>
...
/api/v1/files/briefs/chains/{chain}/latest.json`}</CodeBlock>
          ...
          <div className="mt-6 grid gap-4">
            ...
            <QA question="What does '90d/latest.json' mean?">
              ...
              <div className="mt-3 rounded-xl border border-[#a7c2dd] bg-[#eaf4ff] p-4">
  ...
  "days": [
    ...
    ...90 records total
            ...
            <QA question="Which file should I fetch every day?">
              <span className="font-black text-[#0d2447]">For daily monitoring:</span> fetch <InlineCode>latest.json</InlineCode> (without a window).
              One request per chain, one file, always fresh.
              <br /><br />
              <span className="font-black text-[#0d2447]">For building a historical dataset:</span> fetch <InlineCode>90d/latest.json</InlineCode>
        ...
        <Section id="daily-or-manual" eyebrow="Chapter 5" title="Do I get the data automatically, or do I have to fetch it manually?">
          <Callout color="amber">
            <span className="font-black text-[#0d2447]">Short answer:</span>{" "}
  ...
  -o bitcoin_meta_latest.json`}</CodeBlock>
          ...
          <Callout color="emerald">
            <span className="font-black text-[#0d2447]">Total time for steps 1–6:</span>{" "}
        ...
        <Section id="tools" eyebrow="Chapter 8" title="What software you need on your computer">
          ...
          <div className="mt-5 grid gap-4 lg:grid-cols-3">
            ...
            <div className="rounded-2xl border border-cyan-500/15 bg-cyan-500/5 p-5">
              ...
              <BulletList items={[
                <>Python 3.x — free at <a href="https://python.org" className="font-bold text-blue-700 underline" target="_blank" rel="noopener noreferrer">python.org</a></>,
                "pip install requests (one command)",
                "pip install pandas (for data manipulation)",
                <>VS Code — free code editor at <a href="https://code.visualstudio.com" className="font-bold text-blue-700 underline" target="_blank" rel="noopener noreferrer">code.visualstudio.com</a></>,
...
print(df.to_string(index=False))`}</CodeBlock>
        ...
        <Section id="automation" eyebrow="Chapter 10" title="How to automate daily fetching">
          <Callout>
            <span className="font-black text-[#0d2447]">Do not automate until the manual version works.</span>{" "}
        ...
        <Section id="questions" eyebrow="Chapter 11" title="Common questions — answered directly">
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <QA question="What time does the new data arrive?">
              ...
              <Link href="/status" className="font-bold text-blue-700 underline">/status</Link>{" "}
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <Link key={item.href} href={item.href}
                className="rounded-2xl border border-[#86a9cc] bg-[#d2e4f6] p-4 text-[#0a1d3a] transition hover:bg-[#cfe2f5]">
