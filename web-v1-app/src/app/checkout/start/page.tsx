  ...
  return (
    <main
      style={{
        ...
        padding: "96px 24px",
        background:
          "radial-gradient(circle at 50% 0%, rgba(196,146,48,.10), transparent 34%), var(--surface0)",
      }}
    >
      <section
        style={{
          ...
          borderRadius: "8px",
          background:
            "linear-gradient(180deg, rgba(196,146,48,.075), rgba(17,30,48,.64) 48%, rgba(8,15,26,.92))",
      ...
      >
        ...
        {plan && checkoutAction ? (
          <>
            ...
            >
              You are signed in. Continue with the {planLabel(plan)} plan.{" "}
          ...
          <>
            ...
            >
              The checkout plan is missing or invalid. Return to pricing and choose a
              plan again.
            </p>
