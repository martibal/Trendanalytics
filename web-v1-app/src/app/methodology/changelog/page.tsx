...
import { MethodologyNav, Section, SimpleTable } from "../_components";
  ...
  return (
    <main className="min-h-screen bg-[#edf6ff] text-[#0a1d3a]">
      <PageHero
        ...
        summary="Public customer change log for methodology, interpretation, thresholds, contracts, and historical corrections."
      />
      ...
      >
        ...
        <ShortFullContent
          ...
          summary={
            <>
              This page records customer-facing changes to methodology,
              interpretation, contracts, and historical corrections.
            </>
          }
          bullets={[
            <>
              Every change should be classified by type, backward-compatibility
              impact, methodology bump, archival impact, and subscriber action.
            </>,
            <>
              Docs-only changes should be easy to distinguish from
              output-affecting corrections or methodology-breaking changes.
            </>,
            <>
              Templates for future non-docs changes set the required level of
              specificity before the first real correction arrives.
            </>,
          ]}
          whyItMatters={
            <>
              A clear changelog lowers the cost of trust because users can see
              exactly what changed and whether they need to react.
            </>
          }
          fullContent={
            <div className="grid gap-6">
              <Section title="How to read this changelog">
                <p>
                  Every public change should be classified by type,
                  backward-compatibility impact, whether the methodology version
                  changed, whether archived rows changed, and whether a
                  subscriber needs to take action.
                </p>
              </Section>
              ...
              <Section title="Ready-to-use templates for the first real non-docs change">
                <p>
                  These rows are examples only. They show the level of specificity
                  expected once the first real correction, methodology bump, or
                  archival republish occurs.
                </p>
                <SimpleTable
                  headers={[
                    "Example class",
