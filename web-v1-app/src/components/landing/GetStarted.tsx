...
const STEPS = [
  {
    ...
    value: "Real Gold, Meta, and Derived JSON from published days — including one UNKNOWN/DEGRADED row. This is exactly what the API delivers daily.",
    actions: [
  ...
  },
  {
    ...
    value: "Every field in Gold, Meta, and Derived is documented before you subscribe. The service policy covers publish cadence, AWS upstream dependency, and reply target.",
    actions: [
