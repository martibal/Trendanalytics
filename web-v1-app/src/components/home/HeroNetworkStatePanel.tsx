  ...
  return (
    <>
      <aside className="ua3-hero-network-panel" data-panel-kind="dataset-glance" aria-label="Dataset at a glance">
        ...
        <div className="ua3-hero-panel-offer" aria-label="Sample and pricing entry point">
          <p className="ua3-hero-panel-offer-label">PRICING STARTS AT</p>
          <div className="ua3-hero-panel-price-row">
            <strong>$49</strong>
            <span>/ month</span>
          </div>
          <p className="ua3-hero-panel-offer-copy">Basic covers one selected chain; Pro covers all four for $149/month. Inspect the public sample first, then choose a plan if the format fits your workflow.</p>
...
.ua3-hero-left > .ua3-button-primary {
  border-color: var(--border-subtle);
  background: rgba(255,255,255,0.04);
  color: var(--text-secondary);
}
.ua3-hero-left > .ua3-button-primary:hover {
