  ...
  return {
    ...
    basic: (
      <>
        ...
        <p className="mt-3">
          If you find yourself saying "I already knew transaction volume was up on Ethereum last
          week — I want to know whether that was a structural shift or just noise," this is built
