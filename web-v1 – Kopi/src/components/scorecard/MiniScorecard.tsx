...
export function MiniScorecard({
  ...
  return (
    <div className="mt-3">
      ...
      {/* web6: panel purpose (mini variant) */}
      <div className="mt-3">
        <PanelPurpose
          whatThisShows={
            "A compact, descriptive snapshot of the chain’s operating profile across demand, friction, and capacity, normalized to the chain’s own historical context."
          }
          commonlyUsedFor={[
            "Quickly seeing which dimension labels dominate the current profile without drilling into individual metrics.",
            "Comparing the same chain across dates/windows in a consistent, dimension-based summary.",
            "Reading coverage alongside labels (low coverage can pull scores toward neutral).",
          ]}
          learnMoreHref="/methodology/scorecard"
        />
      </div>
    </div>
  );
