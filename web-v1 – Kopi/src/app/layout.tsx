  ...
  return (
    <footer className="mt-12 border-t border-ui-border bg-ui-bg/40">
      <div className="mx-auto w-full max-w-6xl px-4 py-10">
        ...
        <div className="mt-10 rounded-lg border border-ui-border bg-ui-bg/30 p-6">
          ...
          <div className="mt-4 rounded-lg border border-ui-border bg-[rgb(var(--bad)/0.08)] px-4 py-3 text-[11px] text-ui-faint">
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${syne.variable} ${fraunces.variable} ${dmMono.variable}`}>
      <body className="min-h-screen bg-ui-bg text-ui-text antialiased font-sans">
        <Nav />
