      ...
      <section className="space-y-4">
        ...
        <Card title="Freshness is always explicit">
          <p>
            ...
            We do not hide delays or &ldquo;smooth over&rdquo; missing days. If data is delayed, the UI states it clearly.
          </p>
      ...
      <section className="space-y-4">
        ...
        <Card title="Descriptive endpoints">
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              <CodeInline>/api/export/manifest</CodeInline> — returns chain+genre manifest (as-of, dates, checksums).
            </li>
          </ul>
        </Card>
      </section>
