  ...
  return (
    <section className="space-y-10">
          ...
          <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 text-sm text-ui-muted md:text-base">
                Price-agnostic, descriptive analytics. Regimes, persistence, and historical context — fully explainable, with no
                predictions.
              </p>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div className="ui-card p-5">
          <div className="text-sm font-semibold text-ui-text">Context over signals</div>
          <p className="mt-2 text-sm text-ui-muted">
      ...
      {/* WHO IS THIS FOR */}
      <div className="rounded-3xl border border-ui-border bg-ui-bg p-6">
        <div className="text-sm font-semibold text-ui-text">Who this is for</div>
        <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-3">
          <div className="ui-card p-5">
            <div className="text-sm font-semibold text-ui-text">Serious retail</div>
            <p className="mt-2 text-sm text-ui-muted">
          ...
          <div className="ui-card p-5">
            <div className="text-sm font-semibold text-ui-text">Professionals</div>
            <p className="mt-2 text-sm text-ui-muted">
          ...
          <div className="ui-card p-5">
            <div className="text-sm font-semibold text-ui-text">Institutions</div>
            <p className="mt-2 text-sm text-ui-muted">
