    ...
    <div className={className}>
      ...
      <div className="grid gap-6 lg:grid-cols-2 lg:items-start">
        <div className="space-y-4">
          <ThresholdControls values={normalizedValues} disabled={false} onChange={setValues} />
          {isCustom && (
            <button
              type="button"
              onClick={handleReset}
              className="w-full rounded-xl border px-4 py-2.5 text-sm text-muted-foreground transition hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
